...
namespace TaleKit.Datas.UI.UIItem {
	[Serializable]
	public class UIItem_ScriptText : UIItemBase {
		[ValueEditorComponent_Header("ScriptText Attributes")]
		...
		public UIItem_ScriptText(UIFile ownerFile) : base(ownerFile, UIItemType.ScriptText) {
